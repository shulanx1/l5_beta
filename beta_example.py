...
result_file = 'rand_input_no_stochastic_20s.mat'
...
beta.analyze_beta(cell, electrode, lfp, wd + '\\outputs\\' + result_file, if_plot = 1, if_save = 1)

## blocked NMDA ###
result_file_noNMDA = 'noapicalNMDA' + result_file

rates_e, rates_i = sequences.lognormal_rates(1, P['N_e'], P['N_i'], 1.3, 1)
S_e = sequences.build_rate_seq(rates_e[0], 0, T)
S_i = sequences.build_rate_seq(rates_i[0], 0, T)
...
beta.analyze_beta(cell, electrode, lfp, wd + '\\outputs\\' + result_file_noNMDA, if_plot = 1, if_save = 1)
...
lfp = M @ cell.imem
lfp = lfp*1e3 #unit in uV
beta.analyze_beta(cell, electrode, lfp, wd + '\\outputs\\' + result_file_noCa, if_plot = 1, if_save = 1)